...
public class ServicioSistemaRepository {
    ...
    public ServicioSistema findById(Integer servicioId) {
        ...
        ServicioSistema result = jdbcTemplate.queryForObject(
                QueryUtil.BUSCAR_SERVICIO_SISTEMA_POR_ID,
                new Object[]{servicioId },
                new ServicioSistemaMapper().servicioSistemaRowMapper());
